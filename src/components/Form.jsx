...
const Form = () => {
  ...
  const handleSubmit = () => {
    if (validateStep3()) {
      ...
      AntdMessage.success("Заявка успешно отправлена!");
            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                ...
                >
                  ...
                  <div className="mb-6">
                    <label htmlFor="to" className="block text-sm font-medium mt-5 mb-1">
                      Куда
                    </label>
                    <input
                      id="to"
                  ...
                  <div className="relative inline-block w-full">
                    <motion.button
                      onClick={handleNext}
                      className="relative w-full cursor-pointer bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-md transition-colors mt-25 overflow-hidden"
                    >
                      Далее
                      {/* Shine Effect */}
                      <motion.div
                ...
                >
                  ...
                  <div className="flex gap-3 mt-20">
                    ...
                    <div className="relative inline-block flex-1">
                      <motion.button
                        onClick={handleNext}
                        className="relative w-full cursor-pointer bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-md transition-colors overflow-hidden"
                      >
                        Далее
                        {/* Shine Effect */}
                        <motion.div
